...
export const createIdea = async ({
  ...
  return await appContext.prisma.idea.create({
    data: {
      ...
      text: `Idea ${number} text text text text text text text text text text text text text text text text text text text`,
      ...idea,
    },
  })
}
...
export const createIdeaWithAuthor = async ({
  ...
  const createdAuthor = await createUser({ user: author, number })
  const createdIdea = await createIdea({ idea, author: createdAuthor, number })
  return {
