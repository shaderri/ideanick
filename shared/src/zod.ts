...
export const zNickRequired = zStringRequired.regex(/^[a-z0-9-]+$/, 'Only letters, numbers, dashes are allowed')

export const zStringMin = (min: number) => zStringRequired.min(min, `Must be at least ${min} characters`)
